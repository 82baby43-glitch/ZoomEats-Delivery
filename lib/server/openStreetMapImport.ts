/**
 * OpenStreetMap bulk restaurant import — Next.js mirror of supabase/functions/_shared/openStreetMapImport.ts
 */
...
import { parseOsmOpeningHours } from "./osmOpeningHours";
import { resolveOsmPhotoUrl } from "./osmPhoto";
...
function getOverpassEndpoints(): string[] {
  const custom = process.env.OVERPASS_API_URL;
  if (custom) {
