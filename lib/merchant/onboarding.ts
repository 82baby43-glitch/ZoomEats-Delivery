...
import { DISPENSARY_SLUG, categoryApplicationConfig } from "./categoryConfig";
...
export { DISPENSARY_SLUG } from "./categoryConfig";
export { isLiquorCategory, isAgeRestrictedCategory, isRetailCategory } from "./categoryConfig";
